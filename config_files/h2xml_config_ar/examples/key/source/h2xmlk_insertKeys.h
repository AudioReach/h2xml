/**************************************************************************//**
* @file
* Example for h2xmlk_insertKey
* Use key value enum for multiple keys
*
...
enum AllKeyIds{
	...
	Samplerate2 = 0xA0000001, /**< @h2xmle_name{srate2} */
...
/**
	@h2xmlk_insertKey{Samplerate,Key_Samplerate}
	@h2xmlk_description {Description 10}
*/

/**
	@h2xmlk_insertKey{Samplerate2,Key_Samplerate}
	@h2xmlk_description {Description 11}
...
enum ModuleTag2_Keys {
	tk2_samplerate = Samplerate, /**< h2xmle_ignore{Kv_SampleRate_11025, Kv_SampleRate_44100} */
