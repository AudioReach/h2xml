/**************************************************************************//**
* @file
* * Example for h2xmlm_reqContCapabilities
*
...
/*------------------------------------------------------------------------*//**
    ...
    @h2xmlm_reqContCapabilities     {APM_CONTAINER_CAP_PP, APM_CONTAINER_CAP_MX}
...
/*------------------------------------------------------------------------*//**
    ...
    @h2xmlm_reqContCapabilities     {APM_CONTAINER_CAP_CD,APM_CONTAINER_CAP_EP,APM_CONTAINER_CAP_OLC}
    @h2xmlm_stacksize               {1024}  
    @h2xmlm_dataMaxInputPorts       {4}	
 	@h2xmlm_dataMaxOutputPorts      {6}	
   	@{
