...
/** @h2xmlp_parameter {ExternalParameter1, 0x12345678} */		//<!-- parameter defined outside of module   -->
typedef struct {
...
/**
	@h2xml_Select					{extParam1}						<!-- within the module select the parameter -->
    @h2xmlm_InsertParameter											<!-- add the parameter to the module  -->
